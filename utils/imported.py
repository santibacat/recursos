# Codigo python copiado de otras fuentes

# from https://github.com/wandb/examples/blob/master/keras-cnn-nature/train_small_cnn.py
# codigo para crear un modelo basico CNN con wandb
...
if __name__ == "__main__":
  ...
  # todo lo que viene ahora es del parser, es similar a lo que hay en el proximo apartado.

  



# codigo parecido al anterior para finetuning
# from https://github.com/wandb/examples/blob/master/keras-cnn-nature/finetune_experiments.py
